...
export class EstadisticaComponent implements OnInit, OnDestroy {
  ...
  constructor( private state: Store<AppStateExtends> ) { }

  ngOnInit() {

    this.subscriptionIngresoEgreso = this.state.select('pacientes').subscribe( (data: any) => {
